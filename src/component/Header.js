      ...
      <div className="container">
        <div className="header-content">
          <Link to="/" className="navbar-logo">
            ...
            <span className="t-logo">Billsby Card Tokenizer (React)</span>
          </Link>
          ...
          <div className={`menu-holder ${toggleMenu && 'menu-open'}`}>
            <a href="https://github.com/Billsby/billsby-tokenizer-react" className="btn-white">Download on Github</a>
          </div>
        </div>
      </div>
    </header>
